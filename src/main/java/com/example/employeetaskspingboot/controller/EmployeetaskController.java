...
public class EmployeetaskController {
    ...
    public Map<String,String> Addemployee(@RequestBody Userregistration u){
        System.out.println(u.getEmpcode());
        ...
        System.out.println(u.getDepartment().toString());
        System.out.println(u.getPassword().toString());
        System.out.println(u.getConfirmpass().toString());
        dao1.save(u);
    ...
    public HashMap<String, String> userLogin(@RequestBody Userregistration r){
        System.out.println(r.getEmpcode());
        List<Userregistration> result=(List<Userregistration>) dao1.userLogin(r.getEmpcode(),r.getPassword());
    ...
    public List<Userregistration> GetUserById(@RequestBody Userregistration f){
        return (List<Userregistration>) dao1.FindEmployee(f.getEmpcode());
    }
}
